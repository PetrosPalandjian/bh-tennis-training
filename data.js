...
const EXERCISES=[
  {id:"russian-twist",name:"Russian Twists",cat:"Core",desc:"Sit tall, lean back slightly, rotate through your ribs, and keep the legs quiet. Control every rep.",reps:"20 reps",equip:"Med Ball 8-12lb",youtubeId:"6e8IYh37TGs"},
  {id:"plank",name:"Bodyweight Front Plank",cat:"Core",desc:"Elbows under shoulders, glutes tight, ribs down. Hold a straight line head-to-heels.",reps:"45 sec",equip:"None",youtubeId:"HHwr6faGwWo"},
  ...
  {id:"dead-bug",name:"Bodyweight Deadbug",cat:"Core",desc:"Press low back into the floor, extend opposite arm/leg, and keep ribs down.",reps:"10 each",equip:"None",youtubeId:"Al2Qd7sLsww"},
  {id:"v-ups",name:"Bodyweight V-up",cat:"Core",desc:"Lift legs and torso together, reach tall, then lower under control.",reps:"15 reps",equip:"None",youtubeId:"sh3LH7b81og"},
  {id:"side-plank",name:"Bodyweight Side Plank",cat:"Core",desc:"Stack shoulders and hips, lift to a straight line, and keep the glutes tight.",reps:"30s each",equip:"None",youtubeId:"Em3Fx6wSs6M"},
  ...
  {id:"rot-throw",name:"Medicine Ball Stepping Side Toss",cat:"Rotation",desc:"Load the hips, rotate hard, and throw explosively. Catch and reset under control.",reps:"10 each",equip:"Med Ball + Wall",youtubeId:"XvjzjMw_mXA"},
  {id:"woodchop",name:"Band Low Internal/ External Rotation",cat:"Rotation",desc:"Pull high-to-low on a diagonal, rotate through the torso, and control the return.",reps:"12 each",equip:"Resistance Band",youtubeId:"Xw0rti9b414"},
  {id:"pallof-press",name:"Band Pressout",cat:"Rotation",desc:"Press straight out and resist rotation. Ribs down, glutes on.",reps:"10 each",equip:"Resistance Band",youtubeId:"QW9-F7Ek6hA"},
  ...
  {id:"cone-shuffle",name:"1-2 Cut",cat:"Agility",desc:"Stay low, chest up, and push off the outside leg. Touch the cone and go.",reps:"8 trips",equip:"2 Cones",youtubeId:"XfXHF7z1GDo"},
  {id:"split-step",name:"Vertical Hops",cat:"Agility",desc:"Small hop, land wide on the balls of your feet, then explode to the ball.",reps:"20 reps",equip:"None",youtubeId:"2kow4X1aW-4"},
  ...
  {id:"sprint-back",name:"Sprint 5yds to Backpedal + 15yd Sprint to deceleration",cat:"Agility",desc:"Sprint out, decelerate under control, then backpedal with low hips.",reps:"6 trips",equip:"None",youtubeId:"JH1FsNxIC0A"},
  {id:"lateral-bounds",name:"Lateral Bound w/ Stick",cat:"Agility",desc:"Explode side-to-side, stick the landing, knee over toes, chest up.",reps:"8 each",equip:"None",youtubeId:"RS4JPQSMbRs"},
  {id:"shuffle-sprint",name:"Shuffle, Shuffle Sprint",cat:"Agility",desc:"Shuffle 3-4 steps then explode into a sprint; decelerate under control.",reps:"6 trips",equip:"2 Cones",youtubeId:"kdbjslpOamo"},
  {id:"box-jump",name:"Snap down + Box Jump",cat:"Lower Body",desc:"Swing arms, jump tall, land softly in a squat, and step down each rep.",youtubeId:"D242AlLrT-s",reps:"12 reps",equip:'20-24" Box'},
  {id:"lat-lunge",name:"DB Lateral Lunge",cat:"Lower Body",desc:"Hinge back into the hip, keep the planted leg straight, and drive out strong.",reps:"10 each",equip:"None",youtubeId:"0dR9T1i6HI4"},
  {id:"squat-jump",name:"Continuous Squat Jumps",cat:"Lower Body",desc:"Drop to a strong squat, explode up, and land softly into the next rep.",reps:"15 reps",equip:"None",youtubeId:"XR9mOwi_35g"},
  {id:"single-hop",name:"Single Leg Vertical Hops",cat:"Lower Body",desc:"Hop on one leg, land quietly, knee tracking over toes, then stick the balance.",reps:"8 each",equip:"None",youtubeId:"hv9daqRcbOk"},
  {id:"split-squat",name:"Rear Foot Elevated Split Squat",cat:"Lower Body",desc:"Front foot flat, torso tall, drop straight down, drive up strong.",reps:"8 each",equip:"Dumbbells + Bench",youtubeId:"DRl3iJ_ZxkY"},
  {id:"single-rdl",name:"1 DB SL RDL",cat:"Lower Body",desc:"Hinge at the hip, keep hips square, long spine, slight knee bend.",reps:"8 each",equip:"Dumbbells",youtubeId:"utSTJ781t-A"},
  {id:"calf-raise",name:"Double Leg Calf Raise",cat:"Lower Body",desc:"Full range: pause at the top, squeeze hard, then lower slowly.",reps:"20 reps",equip:"Step",youtubeId:"vHKXP8du6Oo"},
  {id:"copenhagen",name:"Short Lever Copenhagen Side Plank",cat:"Prehab",desc:"Top leg on bench/box, lift hips, keep body long and steady.",reps:"20-30s each",equip:"Bench/Box",youtubeId:"ujwdg1ie7jo"},
  {id:"wall-throw",name:"Half Kneeling Lateral Bound + Medicine Ball Side Toss",cat:"Upper Body",desc:"Explosive chest pass to the wall, catch the rebound, and reset fast.",reps:"15 reps",equip:"Med Ball + Wall",youtubeId:"v6_XQg-oeo0"},
  {id:"pushups",name:"Push-up",cat:"Upper Body",desc:"Hands under shoulders, body straight, chest to floor, full lockout.",reps:"15 reps",equip:"None",youtubeId:"a1yJbaIdRhA"},
  {id:"band-pull",name:"Band Pullaparts",cat:"Upper Body",desc:"Pull the band apart, squeeze shoulder blades, and avoid shrugging.",reps:"15 reps",equip:"Resistance Band",youtubeId:"-As_HP673EI"},
  {id:"band-er",name:"Band External Rotations",cat:"Upper Body",desc:"Elbow at side, rotate forearm out, slow and controlled return.",reps:"12 each",equip:"Resistance Band",youtubeId:"Xw0rti9b414"},
  ...
  {id:"oh-throw",name:"Medicine Ball Stepping OH Throw",cat:"Upper Body",desc:"Load hips, drive up, and throw overhead with full-body power.",reps:"12 reps",equip:"Med Ball",youtubeId:"WK7ZmT8K2lE"},
  {id:"med-slam",name:"Medicine Ball OH Slam",cat:"Upper Body",desc:"Reach tall, slam hard, hinge at hips, reset fast.",reps:"12 reps",equip:"Med Ball",youtubeId:"l6vGRHwRVRI"},
  {id:"jump-rope",name:"Jump Rope",cat:"Cardio",desc:"Small, quick jumps with wrists turning the rope and elbows tucked.",reps:"Full duration",equip:"Jump Rope",youtubeId:"a3wS9xHKLPc"},
...
const STRETCHES=[
  {id:"leg-swings",name:"Leg Swings (Front/Back)",type:"Dynamic",area:"Hips/Hamstrings",desc:"Hold a fence or wall. Swing the leg forward and back under control, stay tall.",reps:"10 each",youtubeId:"rHg6Gypeoe8",youtubeEnd:30},
  {id:"leg-swings-side",name:"Leg Swings (Side-to-Side)",type:"Dynamic",area:"Hips/Groin",desc:"Open the hip and swing across the body, then out to the side.",reps:"10 each",youtubeId:"crhTT59Fj60"},
  {id:"walking-lunge-twist",name:"Walking Lunge + Twist",type:"Dynamic",area:"Hip Flexors/Thoracic",desc:"Step into a lunge, rotate toward the front leg, then switch.",reps:"8 each",youtubeId:"7yrkGWJHSP0",youtubeStart:148,youtubeEnd:178},
  {id:"inch-worms",name:"Inchworms",type:"Dynamic",area:"Posterior Chain/Shoulders",desc:"Hinge forward, walk hands out to plank, then walk feet in.",reps:"6 reps",youtubeId:"SZPEOmobz5E"},
  {id:"worlds-greatest",name:"World's Greatest Stretch",type:"Dynamic",area:"Hips/Thoracic",desc:"Lunge, elbow to instep, then rotate the chest to the sky.",reps:"5 each",youtubeId:"-reO4W7j7Sg"},
  {id:"arm-circles",name:"Arm Circles",type:"Dynamic",area:"Shoulders",desc:"Small to large circles forward and backward.",reps:"20 each way",youtubeId:"14ConGRqj-k",youtubeStart:45,youtubeEnd:75},
  {id:"high-knee-hugs",name:"High Knee Hugs",type:"Dynamic",area:"Glutes/Hips",desc:"Pull knee to chest, rise tall, then switch legs.",reps:"8 each",youtubeId:"o5y2TF3IKVk",youtubeStart:139,youtubeEnd:169},
  {id:"quad-pull-walk",name:"Walking Quad Pull",type:"Dynamic",area:"Quads/Hip Flexors",desc:"Grab ankle, pull heel to glute, squeeze glute, step forward.",reps:"8 each",youtubeId:"Zy8ldV_Cbqg",youtubeStart:198,youtubeEnd:228},
  {id:"a-skips",name:"A-Skips",type:"Dynamic",area:"Calves/Hip Flexors",desc:"Drive the knee up, dorsiflex the foot, and stay tall.",reps:"2 x 15 yards",youtubeId:"Hn6y8jNquVc"},
  {id:"karaoke",name:"Karaoke (Grapevine)",type:"Dynamic",area:"Hips/Groin",desc:"Cross behind and in front while staying low and controlled.",reps:"2 x 15 yards",youtubeId:"uWavy_f2sVY"},
  {id:"lat-lunge-reach",name:"Lateral Lunge + Reach",type:"Dynamic",area:"Adductors/Thoracic",desc:"Sit into the hip, keep the other leg long, and reach over.",reps:"6 each",youtubeId:"ujon6D0nLk8",youtubeStart:292,youtubeEnd:322},
  {id:"open-close-gate",name:"Open/Close the Gate",type:"Dynamic",area:"Hips",desc:"Lift the knee and rotate the hip open, then close across the body.",reps:"8 each",youtubeId:"ufRZ0Y6F2F4",youtubeStart:210,youtubeEnd:240},
  {id:"scorpion",name:"Scorpion Kicks",type:"Dynamic",area:"Hip Flexors/Thoracic",desc:"Prone, lift one leg and reach across to the opposite side.",reps:"6 each",youtubeId:"EjJI5cV3D3o"},
  {id:"shuffle-arm-swing",name:"Side Shuffle + Arm Swings",type:"Dynamic",area:"Hips/Shoulders",desc:"Short lateral shuffles while swinging the arms across the body.",reps:"2 x 10 yards",youtubeId:"7YX7Z8L8caE"},
  {id:"rev-lunge-knee",name:"Reverse Lunge to Knee Drive",type:"Dynamic",area:"Glutes/Balance",desc:"Step back into a lunge, then drive the knee up and hold tall.",reps:"6 each",youtubeId:"QAseZL_2E20",youtubeStart:240,youtubeEnd:270},
  {id:"ankle-hops",name:"Ankle Hops",type:"Dynamic",area:"Ankles/Achilles",desc:"Small quick hops, stay on the balls of your feet.",reps:"20 reps",youtubeId:"2IZj4_UIHD0"},
  {id:"hamstring",name:"Seated Hamstring Stretch",type:"Static",area:"Hamstrings",desc:"Sit tall, hinge at the hips, and reach to the shin or toe.",reps:"30 sec",youtubeId:"UnWd3C7eWjU"},
  {id:"quad",name:"Standing Quad Stretch",type:"Static",area:"Quads",desc:"Knees together, pelvis tucked, hold the ankle gently.",reps:"30 sec each",youtubeId:"UqQhY6q9C_U"},
  {id:"calf",name:"Wall Calf Stretch",type:"Static",area:"Calves",desc:"Back heel down, knee straight, lean into the wall.",reps:"30 sec each",youtubeId:"BXW18-5T8aQ"},
  {id:"hip-flexor",name:"Half-Kneeling Hip Flexor",type:"Static",area:"Hip Flexors",desc:"Tuck pelvis, squeeze glute, shift forward slightly.",reps:"30 sec each",youtubeId:"M0qQj8g6OZs"},
  {id:"figure-4",name:"Figure-4 Glute Stretch",type:"Static",area:"Glutes",desc:"Cross ankle over knee, pull the legs in until you feel the stretch.",reps:"30 sec each",youtubeId:"XW1i6E17d9U"},
  {id:"adductor",name:"Butterfly Groin Stretch",type:"Static",area:"Groin",desc:"Feet together, knees out, hinge forward with a long spine.",reps:"30 sec",youtubeId:"MdEeW1XJ-gA"},
  {id:"childs-pose",name:"Child's Pose",type:"Static",area:"Back/Lats",desc:"Sit hips back, reach long through the arms, breathe deep.",reps:"45 sec",youtubeId:"2MJGg-ykAhE"},
  {id:"cross-body",name:"Cross-Body Shoulder Stretch",type:"Static",area:"Shoulders",desc:"Pull arm across the chest, keep shoulders down.",reps:"30 sec each",youtubeId:"U0BhE67H4rM"},
  {id:"triceps",name:"Overhead Triceps Stretch",type:"Static",area:"Triceps/Shoulders",desc:"Elbow up, gentle pull with the other hand.",reps:"30 sec each",youtubeId:"LqUe1x4v5gQ"},
  {id:"pigeon",name:"Pigeon Stretch",type:"Static",area:"Glutes/Piriformis",desc:"Front leg bent, back leg long, hinge forward as tolerated.",reps:"30 sec each",youtubeId:"0_z4f0YQkMc"},
  {id:"couch-stretch",name:"Couch Stretch",type:"Static",area:"Hip Flexors/Quads",desc:"Back shin on wall/bench, keep ribs down, squeeze glute.",reps:"30 sec each",youtubeId:"3gH7146Vcy4"},
  {id:"soleus",name:"Bent-Knee Calf Stretch",type:"Static",area:"Soleus",desc:"Back heel down, knee bent, lean forward slightly.",reps:"30 sec each",youtubeId:"O12H3t1nNwE"},
  {id:"hamstring-strap",name:"Supine Hamstring with Strap",type:"Static",area:"Hamstrings",desc:"Lie on back, loop strap, and gently straighten the knee.",reps:"30 sec each",youtubeId:"22_tC9_9mC8"},
  {id:"sleeper",name:"Sleeper Stretch",type:"Static",area:"Posterior Shoulder",desc:"Side-lying, gently rotate the forearm down.",reps:"30 sec each",youtubeId:"IBWToThYZgo"},
  {id:"pec-doorway",name:"Doorway Pec Stretch",type:"Static",area:"Chest/Shoulders",desc:"Forearm on the doorframe, step through until gentle stretch.",reps:"30 sec each",youtubeId:"XU5L453a2qA"},
  {id:"forearm",name:"Forearm Flexor/Extensor Stretch",type:"Static",area:"Forearms",desc:"Straight arm, palm down then up, gently pull fingers.",reps:"30 sec each",youtubeId:"7Mx9y1s72aE"},
  {id:"spinal-twist",name:"Supine Spinal Twist",type:"Static",area:"Low Back/Hips",desc:"Knees to one side, shoulders heavy, breathe deep.",reps:"30 sec each",youtubeId:"TeAhhVD2q1c"}
];
