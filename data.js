...
const DRILLS=[
  ...
  {
    id:"cc-bh",name:"Crosscourt Backhand",cat:"Groundstrokes",diff:"Beginner",skill:"Backhand",
  ...
  {
    id:"dtl-fh",name:"Down the Line Forehand",cat:"Groundstrokes",diff:"Intermediate",skill:"Forehand",
  ...
  {
    id:"dtl-bh",name:"Down the Line Backhand",cat:"Groundstrokes",diff:"Intermediate",skill:"Backhand",
  ...
  {
    id:"io-fh",name:"Inside-Out Forehand",cat:"Groundstrokes",diff:"Advanced",skill:"Forehand",
  ...
  {
    id:"fig8",name:"Figure 8 Rally",cat:"Groundstrokes",diff:"Advanced",skill:"Groundstroke",
  ...
  {
    id:"sv-wide-d",name:"Serve Wide Deuce",cat:"Serve & Return",diff:"Intermediate",skill:"Serve+1",
  ...
  {
    id:"sv-t-d",name:"Serve T Deuce",cat:"Serve & Return",diff:"Intermediate",skill:"Serve+1",
  ...
  {
    id:"sv-wide-a",name:"Serve Wide Ad",cat:"Serve & Return",diff:"Intermediate",skill:"Serve+1",
  ...
  {
    id:"sv-kick",name:"Kick Serve + Approach",cat:"Serve & Return",diff:"Advanced",skill:"Serve+1",
  ...
  {
    id:"ret-cc",name:"Return Crosscourt",cat:"Serve & Return",diff:"Beginner",skill:"Return",
  ...
  {
    id:"app-fh",name:"Approach FH + Volley",cat:"Net Play",diff:"Intermediate",skill:"Volley/Net",
  ...
  {
    id:"app-bh",name:"Approach BH + Volley",cat:"Net Play",diff:"Intermediate",skill:"Volley/Net",
  ...
  {
    id:"vol-vol",name:"Volley-to-Volley",cat:"Net Play",diff:"Intermediate",skill:"Volley/Net",
  ...
  {
    id:"oh-drill",name:"Overhead + Recovery",cat:"Net Play",diff:"Advanced",skill:"Overhead",
  ...
  {
    id:"drop-vol",name:"Drop Volley Touch",cat:"Net Play",diff:"Advanced",skill:"Volley/Net",
  ...
  {
    id:"sv-io",name:"Serve + Inside-Out FH",cat:"Patterns",diff:"Advanced",skill:"Patterns",
  ...
  {
    id:"cc-atk",name:"Rally Cross → Attack DTL",cat:"Patterns",diff:"Intermediate",skill:"Patterns",
  ...
  {
    id:"def-off",name:"Defense to Offense",cat:"Patterns",diff:"Advanced",skill:"Patterns",
  ...
  {
    id:"two-ball",name:"Two-Ball Attack",cat:"Patterns",diff:"Intermediate",skill:"Patterns",
  ...
  {
    id:"dbl-poach",name:"Doubles Poach",cat:"Doubles",diff:"Intermediate",skill:"Doubles",
  ...
  {
    id:"dbl-sv",name:"Doubles S&V",cat:"Doubles",diff:"Intermediate",skill:"Doubles",
  ...
  {
    id:"dbl-ifm",name:"I-Formation",cat:"Doubles",diff:"Advanced",skill:"Doubles",
  ...
  {
    id:"dbl-lob",name:"Lob Defense",cat:"Doubles",diff:"Intermediate",skill:"Doubles",
  ...
  // === SKILL FOCUS ADDITIONS (VIDEO-BASED, TIMECODED) ===
  {
    ...
    players:[{id:"S",x:55,y:98,color:BH.shotBlue},{id:"R",x:50,y:5,color:BH.shotRed}],
    steps:[{t:"hit",f:[55,98],to:[50,25],c:BH.shotBlue,n:"1",shot:"serve",hitter:"S",note:"Grip check"}]
  },
  {
  ...
  },
  {
    ...
    players:[{id:"S",x:55,y:98,color:BH.shotBlue},{id:"R",x:50,y:5,color:BH.shotRed}],
    steps:[{t:"hit",f:[55,98],to:[50,22],c:BH.shotBlue,n:"1",shot:"serve",hitter:"S",note:"Toss target"}]
  },
  {
